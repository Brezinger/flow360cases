...
def define_and_run(elev_deflection_deg=0., U_inf = 270, alpha_deg=0., beta_deg=0., rotation=None, half_model=True,
    ...
    if rotation is not None:
        ...
        far_field_zone.private_attribute_entity.center = tuple(c_rot) * u.mm
        far_field_zone.private_attribute_entity.axis = rotation
        srf_rotation = fl.Rotation(
            name="aircraft_motion",
            volumes=[far_field_zone.private_attribute_entity],
